...
class TrainModel:
    def __init__(self, word_vector_algo, ssl_model, init, nrows=1000, vector_size=20, window=5,
        ...
        Args:
            word_vector_algo (str): Type of word vector algorithm to use (either 'Word2Vec' or 'FastText').
    ...
    def train_classifier(self, ssl_model, init):
        ...
        """
        if ssl_model == 'ANN':
            clf = ANNTrainer(get_average_word_embeddings(self.wv_model, self.filtered_tokens),
